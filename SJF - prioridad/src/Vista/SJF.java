...
public class SJF extends Thread {
    ...
    public void run() {
        ...
        listos.cargarTabla(interfaz.getjTableProcesos());
    ...
    public void diagramaGantt(Proceso actual, boolean estado, int transcurrido) {//actualiza diagrama de gantt desde la interfaz gráfica
        String fase;
        if (estado) {
            fase = "X";
        } else {
