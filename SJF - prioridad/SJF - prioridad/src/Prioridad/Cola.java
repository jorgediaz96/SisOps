...
public class Cola {
    ...
    public void verInfoEliminar() {
        if (!colaVacia()) {
            ...
            //String info = "Proceso " + proceso + " con tiempo Rafaga " + tiempoRafaga + "\n";
            if (cab.getSig() == p) {
                p = cab;
                p.setSig(p);
                cab = p;
    ...
    public void imprimir(JTable tabla) {
        ...
        if (!colaVacia()) {
            ...
            txaConsola.append("Total de procesos en cola .........." + tamañoCola() + "\n");
            System.out.println("Total de procesos en cola .........." + tamañoCola() + "\n");
            
            txaConsola.append("**********************************************");
        } else {

            txaConsola.append("\"La cola está vacía \n");
